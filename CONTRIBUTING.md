...
AtlasXCORD is a community project and welcomes any kind of contribution from anyone!

We have development documentation for new contributors, which can be found at <https://docs.AtlasXCORD.org>.
...
To keep AtlasXCORD stable, secure and maintainable, all plugins must follow these rules:
...
## Improving AtlasXCORD Itself

If you want to improve AtlasXCORD beyond plugins, such as internal features or performance improvements, you are welcome to open a feature request so it can be discussed.

Bug fixes, refactors, and documentation improvements are also highly appreciated!

## Helping the Community

We have an open support channel in our [Discord community](https://AtlasXCORD.org/discord).
