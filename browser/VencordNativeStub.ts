...
window.VencordNative = {
    ...
    updater: {
        getRepo: async () => ({ ok: true, value: "https://github.com/HENTUX/AtlasXCORD" }),
    ...
    settings: {
        get: () => {
            try {
                return JSON.parse(localStorage.getItem("AtlasXCORDSettings") || "{}");
            } catch (e) {
                console.error("Failed to parse settings from localStorage: ", e);
                return {};
            }
        },
        set: async (s: Settings) => localStorage.setItem("AtlasXCORDSettings", JSON.stringify(s)),
