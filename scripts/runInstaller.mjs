...
const BASE_URL = "https://github.com/HENTUX/Equilotl/releases/latest/download/";
...
async function ensureBinary() {
    ...
    const res = await fetch(BASE_URL + filename, {
        headers: {
            "User-Agent": "AtlasXCORD (https://github.com/HENTUX/AtlasXCORD)",
            "If-None-Match": etag
        }
    });
...
try {
    execFileSync(installerBin, args, {
        ...
        env: {
            ...process.env,
            AtlasXCORD_USER_DATA_DIR: BASE_DIR,
            AtlasXCORD_DIRECTORY: join(BASE_DIR, "dist/desktop"),
            AtlasXCORD_DEV_INSTALL: "1"
        }
    });
} catch {
