...
const buildConfigs = [
    ...
    },
    {
        ...
        outfile: "dist/AtlasXCORD.user.js",
        banner: {
...
async function buildExtension(target, files) {
    const entries = {
        "dist/AtlasXCORD.js": await readFile("dist/browser/extension.js"),
        "dist/AtlasXCORD.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/AtlasXCORD.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/AtlasXCORD.user.js", cssRuntime);
});
