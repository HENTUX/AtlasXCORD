...
import { Devs, AtlasXCORDDevs, SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
const TEXT_REPLACE_RULES_EXEMPT_CHANNEL_IDS = [
    ...
    "1419347113745059961", // AtlasXCORD's Requests Channel
    ...SUPPORT_CHANNEL_IDS
];
...
export default definePlugin({
    ...
    authors: [Devs.AutumnVN, Devs.TheKodeToad, AtlasXCORDDevs.Etorix, AtlasXCORDDevs.Ape],
    isModified: true,
    settings,
