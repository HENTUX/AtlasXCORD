...
import { Devs, EQUIBOT_USER_ID, AtlasXCORDDevs, SUPPORT_CHANNEL_ID, VC_SUPPORT_CATEGORY_ID, VENBOT_USER_ID } from "@utils/constants";
...
export default definePlugin({
    ...
    tags: ["Chat", "Utility"],
    authors: [Devs.rushii, Devs.Ven, Devs.AutumnVN, Devs.Nickyux, Devs.Kyuuhachi, Devs.sadan, AtlasXCORDDevs.justjxke],
