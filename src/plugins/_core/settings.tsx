...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the AtlasXCORD settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        if (layout.some(s => s?.key === "AtlasXCORD_section")) return layout;

        const { buildEntry } = this;

        const AtlasXCORDEntries: SettingsLayoutNode[] = [
            buildEntry({
                key: "AtlasXCORD_main",
                title: "AtlasXCORD",
                panelTitle: "AtlasXCORD Settings",
                Component: VencordTab,
                Icon: MainSettingsIcon
            }),
            buildEntry({
                key: "AtlasXCORD_plugins",
                title: "Plugins",
                Component: PluginsTab,
                Icon: PluginsIcon
            }),
            buildEntry({
                key: "AtlasXCORD_themes",
                title: "Themes",
                Component: ThemesTab,
                Icon: PaintbrushIcon
            }),
            !IS_UPDATER_DISABLED && UpdaterTab && buildEntry({
                key: "AtlasXCORD_updater",
                title: "Updater",
                panelTitle: "AtlasXCORD Updater",
                Component: UpdaterTab,
                Icon: UpdaterIcon
            }),
            buildEntry({
                key: "AtlasXCORD_changelog",
                title: "Changelog",
                Component: ChangelogTab,
                Icon: LogIcon,
            }),
            buildEntry({
                key: "AtlasXCORD_cloud",
                title: "Cloud",
                panelTitle: "AtlasXCORD Cloud",
                Component: CloudTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "AtlasXCORD_backup_restore",
                title: "Backup & Restore",
                Component: BackupAndRestoreTab,
                Icon: BackupRestoreIcon
            }),
            !IS_STANDALONE && PatchHelperTab && buildEntry({
                key: "AtlasXCORD_patch_helper",
                title: "Patch Helper",
        ...
        const AtlasXCORDSection: SettingsLayoutNode = {
            key: "AtlasXCORD_section",
            type: LayoutTypes.SECTION,
            useTitle: () => "AtlasXCORD Settings",
            buildLayout: () => AtlasXCORDEntries
        };
        ...
        layout.splice(idx, 0, AtlasXCORDSection);
    ...
    getInfoRows() {
        ...
        const rows = [`AtlasXCORD ${gitHashShort}${getVersionInfo()}`];
