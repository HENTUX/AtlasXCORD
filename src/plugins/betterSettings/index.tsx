...
import { AchievementsIcon, AppsIcon, CreditCardIcon, AtlasXCORDIcon, GameControllerIcon, HammerAndChiselIcon, MainSettingsIcon, PencilSparkleIcon, UserIcon } from "@components/Icons";
import { buildPluginMenuEntries, buildThemeMenuEntries } from "@equicordplugins/AtlasXCORDToolbox/menu";
...
const SECTION_ICONS: Record<string, Icon> = {
    ...
    AtlasXCORD_section: AtlasXCORDIcon,
...
export default definePlugin({
    ...
    transformSettingsEntries(list) {
        ...
        for (const item of flat) {
            ...
            if (key === "AtlasXCORD_plugins" || key === "AtlasXCORD_themes") {
                const children = key === "AtlasXCORD_plugins"
