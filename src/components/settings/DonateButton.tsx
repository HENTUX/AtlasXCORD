...
export function DonateButton({
    ...
    className,
    ...props
}: Partial<ButtonProps> & { AtlasXCORD?: boolean; }) {
    const link = AtlasXCORD ? "https://github.com/sponsors/thororen1234" : "https://github.com/sponsors/Vendicated";
    return (
        <Button
            {...props}
            variant="none"
...
export function TranslateButton({
    ...
    const link = "https://weblate.AtlasXCORD.org/projects/AtlasXCORD/";
    return (
        <Button
            {...props}
            variant="none"
