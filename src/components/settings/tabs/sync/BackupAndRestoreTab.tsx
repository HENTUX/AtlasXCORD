    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom20}>
                Import and export your AtlasXCORD settings as a JSON file. This allows you to easily transfer your settings to another device, or recover them after reinstalling AtlasXCORD or Discord.
            </Paragraph>
            ...
            <Paragraph className={Margins.bottom20}>
                â€¢ Custom QuickCSS<br />
                â€¢ Theme Links<br />
                â€¢ Plugin Settings<br />
                â€¢ DataStore Data
            </Paragraph>
