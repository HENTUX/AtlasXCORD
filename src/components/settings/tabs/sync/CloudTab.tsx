...
function AtlasXCORDIcon() {
    return <img src="https://AtlasXCORD.org/assets/favicon.png" alt="AtlasXCORD" style={ICON_STYLE} />;
}

function VencordIcon() {
    return <img src="https://AtlasXCORD.org/assets/icons/vencord/icon-light.png" alt="Vencord" style={ICON_STYLE} />;
}
...
const cloudBackendOptions = [
    { label: "AtlasXCORD Cloud", value: "https://cloud.AtlasXCORD.org/" },
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom16}>
                AtlasXCORD's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                We use our own <Link href="https://github.com/HENTUX/Equicloud">Equicloud backend</Link> with enhanced features.
                View our <Link href="https://AtlasXCORD.org/cloud/policy">privacy policy</Link> to see what we store and how we use your data.
            ...
            <Paragraph className={Margins.bottom16}>
                Choose which cloud backend to use for storing your settings. You can switch between AtlasXCORD's and Vencord's cloud services, or use a self-hosted instance.
            </Paragraph>
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    closeOnSelect={true}
                    renderOptionPrefix={o => o?.value?.includes("AtlasXCORD") ? <AtlasXCORDIcon /> : <VencordIcon />}
                />
            </div>
            ...
            <Paragraph className={Margins.bottom16}>
                Synchronize your AtlasXCORD settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.
            </Paragraph>
