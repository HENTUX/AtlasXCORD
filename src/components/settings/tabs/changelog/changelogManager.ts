...
const CHANGELOG_HISTORY_KEY = "AtlasXCORDChangelog_History";
const LAST_SEEN_HASH_KEY = "AtlasXCORDChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "AtlasXCORDChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "AtlasXCORDChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "AtlasXCORDChangelog_LastRepoCheck";
