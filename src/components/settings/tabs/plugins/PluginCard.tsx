...
export function PluginCard({ plugin, disabled, onRestartNeeded, onMouseEnter, onMouseLeave, isNew }: PluginCardProps) {
    ...
    const isAtlasXCORDPlugin = pluginMeta.folderName.startsWith("src/equicordplugins/") ?? false;
    ...
    const pluginInfo = [
        {
            ...
            src: "https://AtlasXCORD.org/assets/icons/AtlasXCORD/modified.png",
            alt: "Modified",
            title: "Modified Vencord Plugin"
        },
        {
            condition: isAtlasXCORDPlugin,
            src: "https://AtlasXCORD.org/assets/favicon.png",
            alt: "AtlasXCORD",
            title: "AtlasXCORD Plugin"
        },
        {
            condition: isVencordPlugin,
            src: "https://AtlasXCORD.org/assets/icons/vencord/icon-light.png",
            alt: "Vencord",
            title: "Vencord Plugin"
        },
        {
            condition: isUserPlugin,
            src: "https://AtlasXCORD.org/assets/icons/misc/userplugin.png",
            alt: "User",
            title: "User Plugin"
        }
    ];
