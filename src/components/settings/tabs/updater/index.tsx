...
function EquibopSection() {
    ...
    return (
        <Flex className={Margins.bottom20} flexDirection="column" gap="1em">
            <Card variant="brand">
                <HeadingSecondary>Equibop & AtlasXCORD</HeadingSecondary>
                <Paragraph>Equibop and AtlasXCORD are two separate things. This updater is for AtlasXCORD.</Paragraph>
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom20}>
                Control how AtlasXCORD keeps itself up to date. You can choose to update automatically in the background or be notified when new updates are available.
            </Paragraph>

            <FormSwitch
                title="Automatically update"
                description="When enabled, AtlasXCORD will automatically download and install updates in the background without asking for confirmation. You'll need to restart Discord to apply the changes."
            ...
            <FormSwitch
                ...
                description="Receive a notification when AtlasXCORD finishes downloading an update in the background, so you know when to restart Discord."
            ...
            <Paragraph className={Margins.bottom8}>
                This is the GitHub repository where AtlasXCORD fetches updates from.
            </Paragraph>
