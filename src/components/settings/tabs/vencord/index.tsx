...
const SHIGGY_DONATE_IMAGE = "https://AtlasXCORD.org/assets/favicon.png";
...
function AtlasXCORDSettings() {
    ...
    return (
        <SettingsTab>
            {(isAtlasXCORDDonor(user?.id) || isVencordDonor(user?.id)) ? (
                <SpecialCard
                    title="Donations"
                    subtitle="Thank you for donating!"
                    description={
                        isAtlasXCORDDonor(user?.id) && isVencordDonor(user?.id)
                            ? "All Vencord users can see your Vencord donor badge, and AtlasXCORD users can see your AtlasXCORD donor badge. To change your Vencord donor badge, contact @vending.machine. For your AtlasXCORD donor badge, make a ticket in AtlasXCORD's server."
                            : isVencordDonor(user?.id)
                                ? "All Vencord users can see your badge! You can manage your perks by messaging @vending.machine."
                                : "All AtlasXCORD users can see your badge! You can manage your perks by making a ticket in AtlasXCORD's server."
                    }
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of AtlasXCORD by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to AtlasXCORD you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how AtlasXCORD behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
            ...
            <div style={{ textAlign: "center", padding: "16px 0 8px", opacity: 0.5, fontSize: 12 }}>
                Copyright 2026 HENTUX - github.com/HENTUX/AtlasXCORD - All rights reserved
            </div>
        </SettingsTab >
    );
}

export default wrapTab(AtlasXCORDSettings, "AtlasXCORD Settings");

export function isAtlasXCORDDonor(userId: string): boolean {
    const donorBadges = BadgeAPI.getAtlasXCORDDonorBadges(userId);
