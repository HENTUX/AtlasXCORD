...
import AtlasXCORDToolbox from "@equicordplugins/AtlasXCORDToolbox";
...
function SpotifyActivityToggleButton({ iconForeground, hideTooltips, nameplate }: UserAreaRenderProps) {
    ...
    if (!isLoaded || !spotifyId || location !== "PANEL" && isPluginEnabled(AtlasXCORDToolbox.name)) return null;
...
const settings = definePluginSettings({
    location: {
        ...
        options: [
            ...
            { label: "AtlasXCORD Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(AtlasXCORDToolbox.name);
        }
    },
});
