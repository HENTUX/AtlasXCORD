...
export default definePlugin({
    ...
    tags: ["Fun"],
    authors: [AtlasXCORDDevs.SomeAspy, Devs.thororen],
    dependencies: ["AudioPlayerAPI"],
    settings,
    start() {
        croissant = createAudioPlayer("https://github.com/HENTUX/Equibored/raw/main/sounds/equissant/croissant.mp3", { persistent: true });
