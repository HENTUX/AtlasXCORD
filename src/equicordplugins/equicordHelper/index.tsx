...
import { Devs, AtlasXCORDDevs, GUILD_ID, SUPPORT_CHANNEL_ID, SUPPORT_CHANNEL_IDS, VC_SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
migratePluginToSettings(true, "AtlasXCORDHelper", "NoBulletPoints", "noBulletPoints");
migratePluginToSettings(true, "AtlasXCORDHelper", "NoModalAnimation", "noModalAnimation");
migratePluginToSettings(true, "AtlasXCORDHelper", "GuildTagSettings", "disableAdoptTagPrompt");
...
export default definePlugin({
    ...
    authors: [
        Devs.thororen,
        AtlasXCORDDevs.nyx,
        AtlasXCORDDevs.Naibuu,
        AtlasXCORDDevs.keircn,
        AtlasXCORDDevs.SerStars,
        AtlasXCORDDevs.mart,
        AtlasXCORDDevs.omaw,
        Devs.Samwich,
        Devs.AutumnVN,
        AtlasXCORDDevs.auggeeo
    ],
    required: true,
    settings,
    headerBarButton: {
        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    ...
                    body: "Before asking for help. Check updates and if this issue is actually caused by AtlasXCORD!",
                    confirmText: "AtlasXCORD Support",
                    onConfirm() {
