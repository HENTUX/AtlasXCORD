        ...
        >
            {(_, { isShown }) => (
                <HeaderBarButton
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "AtlasXCORD Toolbox"}
                    icon={Icon}
                    selected={isShown}
                />
            )}
...
migratePluginSettings("AtlasXCORDToolbox", "VencordToolbox");
export default definePlugin({
    name: "AtlasXCORDToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses AtlasXCORD quick actions",
