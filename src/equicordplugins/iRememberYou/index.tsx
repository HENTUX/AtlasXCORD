...
export default definePlugin({
    ...
    tags: ["Chat", "Servers"],
    authors: [AtlasXCORDDevs.zoodogood, AtlasXCORDDevs.keircn],
    ...
    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "AtlasXCORD_i_remember_you");
