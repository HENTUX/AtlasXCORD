...
export default definePlugin({
    ...
    tags: ["Developers"],
    authors: [AtlasXCORDDevs.iamme],
    dependencies: ["Settings", "ConcatenatedModules"],
    startAt: StartAt.WebpackReady,
    toolboxActions: {
        "Open Icons Tab"() {
            SettingsRouter.openUserSettings("AtlasXCORD_icon_viewer_panel");
        },
    },
    settingsAboutComponent: SettingsAbout,
    start() {
        SettingsPlugin.customEntries.push({
            key: "AtlasXCORD_icon_viewer",
            title: "Icon Finder",
            Component: IconsTab,
    ...
    stop() {
        removeFromArray(SettingsPlugin.customEntries, e => e.key === "AtlasXCORD_icon_viewer");
    },
});
