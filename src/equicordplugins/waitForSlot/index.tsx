...
const NOTIFICATION_AUDIO_URL = "https://raw.githubusercontent.com/AtlasXCORD/Equibored/main/sounds/waitForSlot/notification.mp3";
...
export default definePlugin({
    ...
    authors: [AtlasXCORDDevs.omaw, Devs.prism],
    settings,
    patches: [
        {
