...
export const actions: ButtonAction[] = [
    { id: "openAtlasXCORDSettings", label: "Open AtlasXCORD tab", callback: async () => await SettingsRouter.openUserSettings("AtlasXCORD_main_panel"), registrar: "AtlasXCORD" },
    { id: "openPluginSettings", label: "Open Plugin tab", callback: () => SettingsRouter.openUserSettings("AtlasXCORD_plugins_panel"), registrar: "AtlasXCORD" },
    { id: "openThemesSettings", label: "Open Themes tab", callback: () => SettingsRouter.openUserSettings("AtlasXCORD_themes_panel"), registrar: "AtlasXCORD" },
    { id: "openUpdaterSettings", label: "Open Updater tab", callback: () => SettingsRouter.openUserSettings("AtlasXCORD_updater_panel"), registrar: "AtlasXCORD" },
    { id: "openAtlasXCORDCloudSettings", label: "Open Cloud tab", callback: () => SettingsRouter.openUserSettings("AtlasXCORD_cloud_panel"), registrar: "AtlasXCORD" },
    { id: "openBackupSettings", label: "Open Backup & Restore tab", callback: () => SettingsRouter.openUserSettings("AtlasXCORD_backup_restore_panel"), registrar: "AtlasXCORD" },
    { id: "restartClient", label: "Restart Client", callback: () => relaunch(), registrar: "AtlasXCORD" },
    { id: "openQuickCSSFile", label: "Open Quick CSS File", callback: () => VencordNative.quickCss.openEditor(), registrar: "AtlasXCORD" },
    { id: "openSettingsFolder", label: "Open Settings Folder", callback: async () => showItemInFolder(await VencordNative.settings.getSettingsDir()), registrar: "AtlasXCORD" },
    { id: "openInGithub", label: "Open in Github", callback: async () => VencordNative.native.openExternal(await getRepo()), registrar: "AtlasXCORD" },
        ...
        id: "checkForUpdates", label: "Check for Updates", callback: async () => {
            ...
            if (isOutdated) {
                setTimeout(() => showNotification({
                    title: "A AtlasXCORD update is available!",
                    body: "Click here to view the update",
                    permanent: true,
                    noPersist: true,
                    onClick() {
                        SettingsRouter.openUserSettings("AtlasXCORD_updater_panel");
                    }
                }), 10_000);
            } else {
                Toasts.show({
