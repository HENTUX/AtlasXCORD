...
const settings = definePluginSettings({
    ...
    imageLink: {
        ...
        type: OptionType.STRING,
        default: "https://AtlasXCORD.org/assets/plugins/soggy/cat.png",
    },
    songLink: {
        description: "URL for the song to play",
        type: OptionType.STRING,
        default: "https://github.com/HENTUX/Equibored/raw/main/sounds/soggy/song.mp3?raw=true",
        onChange(newValue) {
    ...
    boopLink: {
        ...
        type: OptionType.STRING,
        default: "https://github.com/HENTUX/Equibored/raw/main/sounds/soggy/honk.wav?raw=true",
        onChange(newValue) {
