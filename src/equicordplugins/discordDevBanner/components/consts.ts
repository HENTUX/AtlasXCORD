...
export const settings = definePluginSettings({
    format: {
        ...
        default: "{AtlasXCORDIcon} AtlasXCORD {AtlasXCORDVersion} ({AtlasXCORDHash})",
        restartNeeded: true
    }
});
...
export const settingVariables = [
    ...
    "",
    "AtlasXCORD Variables:",
    "{AtlasXCORDIcon} - AtlasXCORD icon",
    "{AtlasXCORDVersion} - Version of AtlasXCORD (e.g. 1.0.0)",
    "{AtlasXCORDHash} - AtlasXCORD build hash (e.g. 123456789)",
    "{AtlasXCORDPlatform} - Platform AtlasXCORD is running on (e.g. Dev Build)",
    "",
