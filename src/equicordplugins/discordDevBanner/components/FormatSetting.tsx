...
export function FormatSetting(setValue) {
    ...
    const [state, setState] = useState(format ?? "{buildChannel} {buildNumber} ({buildHash}) | {AtlasXCORDName} {AtlasXCORDVersion} ({AtlasXCORDHash})");
    ...
    return (
        <section>
            ...
            <textarea
                ...
                placeholder="{buildChannel} {buildNumber} ({buildHash}) | {AtlasXCORDName} {AtlasXCORDVersion} ({AtlasXCORDHash})"
                rows={1}
                ref={el => {
                    if (el) {
