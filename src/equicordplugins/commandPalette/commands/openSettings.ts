...
export const DISCORD_SETTINGS_ROUTES: SettingsRoute[] = [
    ...
    { route: "AtlasXCORD_main", label: "AtlasXCORD", keywords: ["vencord"] },
    { route: "AtlasXCORD_plugins", label: "AtlasXCORD Plugins", keywords: ["plugins"] },
    { route: "AtlasXCORD_themes", label: "AtlasXCORD Themes", keywords: ["themes", "css"] },
    { route: "AtlasXCORD_updater", label: "AtlasXCORD Updater", keywords: ["update"] },
    { route: "AtlasXCORD_changelog", label: "AtlasXCORD Changelog", keywords: ["changelog", "news"] }
];
...
const ROUTE_ALIASES = new Map<string, string[]>([
    ...
    ["AtlasXCORD_main", ["AtlasXCORD_main_panel"]],
    ["AtlasXCORD_plugins", ["AtlasXCORD_plugins_panel"]],
    ["AtlasXCORD_themes", ["AtlasXCORD_themes_panel"]],
    ["AtlasXCORD_updater", ["AtlasXCORD_updater_panel"]],
    ["AtlasXCORD_changelog", ["AtlasXCORD_changelog_panel"]]
]);
