...
export const AtlasXCORD_TEAM = "1173520023239786538";
export const AtlasXCORD_HELPERS = "1326406112144265257";
...
export const AtlasXCORDDevs = Object.freeze({
    nobody: {
        name: "nobody",
        id: 0n
    },
...
export const AtlasXCORDDevsById = /* #__PURE__*/ (() =>
    Object.freeze(Object.fromEntries(
        Object.entries(AtlasXCORDDevs)
            .filter(d => d[1].id !== 0n)
            .map(([_, v]) => [v.id, v] as const)
    ))
)() as Record<string, Dev>;
