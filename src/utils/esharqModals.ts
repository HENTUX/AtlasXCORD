...
// Esharq's @utils/modal exports the low-level modal building blocks (ModalRoot, ModalHeader, ΓÇª)
// as the deprecated `never` type ΓÇö they work at runtime but can't be composed type-safely. This
