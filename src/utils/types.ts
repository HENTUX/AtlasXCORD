...
export interface PluginDef {
    ...
    /*
    * Custom apis added by AtlasXCORD and were placed here for quicker identification rather then mixing them in
    */
    ...
    /**
     * A Vencord plugin that is modified for extra features in AtlasXCORD
     */
    isModified?: boolean;
}
